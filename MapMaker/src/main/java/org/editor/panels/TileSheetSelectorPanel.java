...
import org.editor.GUI;
import org.editor.tables.ComboItem;

import org.editor.tables.*;
...
public class TileSheetSelectorPanel extends JPanel {
    ...
    public TileSheetSelectorPanel(GUI gui){
        ...
        for(TileSheetData tileSheetImage : gpTileSheetData){
            ...
            try {
                ...
                imageButtons[index].addActionListener(e -> {
                    ...
                    gui.importTileSheet(tileSheetImage.packageID, tileSheetImage.tileSheet_ID, directory);
