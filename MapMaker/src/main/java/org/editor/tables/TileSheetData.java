...
public class TileSheetData implements Serializable{
    ...
    public static String saveFilePath = "./resources/data_files/tile_sheet_data.dat";
    @Serial
    ...
    private static void readDataFromDisk(){
        ...
        String tileSheetDataListString = "";
        ...
        try{
            FileInputStream readData = new FileInputStream("./resources/data_files/tile_sheet_data.txt");
            ObjectInputStream readStream = new ObjectInputStream(readData);

            tileSheetDataListString = (String) readStream.readObject();
        ...
        Type listType = new TypeToken<ArrayList<TileSheetData>>(){}.getType();
        tileSheetDataList = gson.fromJson(tileSheetDataListString,  listType);
