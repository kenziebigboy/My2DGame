...
public class GraphicsPackages implements Serializable{
    ...
    static String path = "./resources/data_files/graphics_packages.txt";
    ...
    public static void readDataFromDisk(){
        ...
        String graphicsPackageListString = "";
        ...
        try{
            ...
            graphicsPackageListString  = (String) readStream.readObject();
        ...
        Type listType = new TypeToken<ArrayList<GraphicsPackages>>(){}.getType();
        graphicsPackagesList = gson.fromJson(graphicsPackageListString,  listType);
    ...
    private static void writeDataToDisk(){
        ...
        String graphicsPackageListString = "";
        String nextGraphicsPackageIDString = "";

        ObjectMapper objectMapper = new ObjectMapper();

        try {
            graphicsPackageListString = objectMapper.writeValueAsString(graphicsPackagesList);
            nextGraphicsPackageIDString = objectMapper.writeValueAsString(nextGraphicsPackageID);
        ...
        try{
            ...
            writeStream.writeObject(graphicsPackageListString);
            writeStream.writeObject(nextGraphicsPackageIDString);
            writeStream.flush();
            writeStream.close();
